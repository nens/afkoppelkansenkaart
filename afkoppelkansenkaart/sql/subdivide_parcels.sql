...
DROP TABLE IF EXISTS kadastraal_perceel_subdivided CASCADE;
...
SELECT 	row_number() over() AS id, 
        ...
        ST_Area(ST_Force3D(ST_Multi(ST_Buffer(nw.geom,0)))::geometry(MultiPolygonZ, 28992)) AS oppervlakte_perceel,
        ...
        NULL::double precision geschiktheid_infiltratie,
